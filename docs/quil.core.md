...
- [x] [`abs`](https://github.com/quil/quil/blob/2.8.0/src/cljc/quil/core.cljc#L265) - "Calculates the absolute value (magnitude) of a number"
...
- [x] [`alpha`](https://github.com/quil/quil/blob/2.8.0/src/cljc/quil/core.cljc#L297) - "Extracts the alpha value from a color"
...
- [x] [`blue`](https://github.com/quil/quil/blob/2.8.0/src/cljc/quil/core.cljc#L815) - "Extracts the blue value from a color, scaled to match current color-mode"
- [ ] [`box`](https://github.com/quil/quil/blob/2.8.0/src/cljc/quil/core.cljc#L827) - "Creates an extruded rectangle"
- [x] [`brightness`](https://github.com/quil/quil/blob/2.8.0/src/cljc/quil/core.cljc#L838) - "Extracts the brightness value from a color"
...
- [x] [`ceil`](https://github.com/quil/quil/blob/2.8.0/src/cljc/quil/core.cljc#L882) - "Calculates the closest int value that is greater than or equal to  the value of the parameter"
...
- [x] [`exit`](https://github.com/quil/quil/blob/2.8.0/src/cljc/quil/core.cljc#L1522) - "Quits/stops/exits the program"
- [x] [`exp`](https://github.com/quil/quil/blob/2.8.0/src/cljc/quil/core.cljc#L1536) - "Returns Euler's number e (2"
...
- [x] [`floor`](https://github.com/quil/quil/blob/2.8.0/src/cljc/quil/core.cljc#L1656) - "Calculates the closest int value that is less than or equal to the  value of the parameter"
...
- [x] [`green`](https://github.com/quil/quil/blob/2.8.0/src/cljc/quil/core.cljc#L1776) - "Extracts the green value from a color, scaled to match current  color-mode"
...
- [x] [`no-fill`](https://github.com/quil/quil/blob/2.8.0/src/cljc/quil/core.cljc#L2502) - "Disables filling geometry"
...
- [x] [`no-stroke`](https://github.com/quil/quil/blob/2.8.0/src/cljc/quil/core.cljc#L2675) - "Disables drawing the stroke (outline)"
...
- [x] [`noise`](https://github.com/quil/quil/blob/2.8.0/src/cljc/quil/core.cljc#L2514) - "Returns the Perlin noise value at specified coordinates"
...
- [x] [`pow`](https://github.com/quil/quil/blob/2.8.0/src/cljc/quil/core.cljc#L2872) - "Facilitates exponential expressions"
...
- [x] [`red`](https://github.com/quil/quil/blob/2.8.0/src/cljc/quil/core.cljc#L3175) - "Extracts the red value from a color, scaled to match current color-mode"
...
- [x] [`round`](https://github.com/quil/quil/blob/2.8.0/src/cljc/quil/core.cljc#L3390) - "Calculates the integer closest to the value parameter"
- [x] [`saturation`](https://github.com/quil/quil/blob/2.8.0/src/cljc/quil/core.cljc#L3403) - "Extracts the saturation value from a color"
...
- [x] [`sq`](https://github.com/quil/quil/blob/2.8.0/src/cljc/quil/core.cljc#L3838) - "Squares a number (multiplies a number by itself)"
- [x] [`sqrt`](https://github.com/quil/quil/blob/2.8.0/src/cljc/quil/core.cljc#L3852) - "Calculates the square root of a number"
...
- [x] [`state`](https://github.com/quil/quil/blob/2.8.0/src/cljc/quil/core.cljc#L227) - "Retrieve sketch-specific state by key"
...
- [x] [`with-fill`](https://github.com/quil/quil/blob/2.8.0/src/cljc/quil/core.cljc#L4426) - "Temporarily set the fill color for the body of this macro"
...
- [x] [`with-stroke`](https://github.com/quil/quil/blob/2.8.0/src/cljc/quil/core.cljc#L4455) - "Temporarily set the stroke color for the body of this macro"
- [x] [`with-translation`](https://github.com/quil/quil/blob/2.8.0/src/cljc/quil/core.cljc#L4484) - "Performs body with translation, restores current transformation on  exit"
